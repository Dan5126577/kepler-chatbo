...
4) Visit Kepler College Campus located in Gasabo District, Kinyinya Sector at KG 29 Ave 16.""",
    ...
    "Can I apply before getting my High School certificate?": "No, you cannot apply without either a high school certificate or a result slip because it is among the application and admission requirements in general.",

    "How many years do students study to get their Bachelor degrees?": "All degree programs that are offered at Kepler College last for three academic years (3 years).",
...
3) Visit Kepler College Campus located in Gasabo District, Kinyinya Sector at KG 29 Ave 16.""",
    ...
    "How many Intakes are there in an academic year?": "Admissions are conducted separately for each of our three programs, with one intake per program each year. Admission timelines may vary, so please check our website for the specific timeline of the program you wish to join.",
    ...
    "Are there options for part-time or distance learning?": "Kepler College does not offer flexible learning schedules in terms of part-time or distance learning. Nevertheless, all content is uploaded on our LMS for the students to get access lessons everywhere at anytime.",
